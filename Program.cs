...
namespace EncryptedText
{
    class Program
    {
        ...
        //private const string secretKey = "ComplexKeyHere_12121";

        //This method is used to convert the plain text to Encrypted/Un-Readable Text format.
        public static string EncryptPlainTextToCipherText(string PlainText, string PrivateKey)
        {
            ...
            byte[] securityKeyArray = objMD5CryptoService.ComputeHash(UTF8Encoding.UTF8.GetBytes(PrivateKey));
        ...
        public static string DecryptCipherTextToPlainText(string CipherText, string PrivateKey)
        {
